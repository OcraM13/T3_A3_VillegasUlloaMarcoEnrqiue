...
function cadenas(){
  ...
  var cadena = document.getElementById("caja_Texto").value.toUpperCase();;
  ...
  document.getElementById("caja_vocales").value = contadorV;
  document.getElementById("caja_consonantes").value = contadorC;
  document.getElementById("caja_repeticiones").value = letras_usadas;
